...
Aire asks users to acknowledge the service when publishing research papers,
posters, presentations, or similar outputs that have made use of the system.
The required sentence:

> This work was undertaken on the Aire HPC system at the University of Leeds, UK.

Include it in the dissertation acknowledgements section and any derived
publications. See also README.md → Acknowledgements.
